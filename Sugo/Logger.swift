...
class Logger {
    ...
    /// debug: Adds a debug message to the Sugo log
    ...
    /// info: Adds an informational message to the Sugo log
    /// - Parameter message: The message to be added to the log
    ...
    /// warn: Adds a warning message to the Sugo log
    /// - Parameter message: The message to be added to the log
    ...
    /// error: Adds an error message to the Sugo log
    /// - Parameter message: The message to be added to the log
