...
class Swizzler {
    ...
    class func swizzleSelector(_ originalSelector: Selector,
                               ...
                               for originalClass: AnyClass,
                               and newClass: AnyClass? = nil,
                               name: String,
        ...
        if let newClass = newClass {
            swizzleClass = newClass
        } else {
            swizzleClass = originalClass
        }
        ...
        if let originalMethod = class_getInstanceMethod(originalClass, originalSelector),
            ...
            let didAddMethod = class_addMethod(originalClass,
                                               originalSelector,
            ...
            Logger.error(message: "Swizzling error: Cannot find method for "
                + "\(NSStringFromSelector(originalSelector)) on \(NSStringFromClass(originalClass))")
        }
    }
